                    ...
                    public void onReceived(ARequest aRequest, AResponse aResponse, IConnectRrpcHandle iConnectRrpcHandle) {
                        ...
                        try {
                            if (aRequest != null) {
                                ...
                                // 仅供参考
                                ShadowResponse<String> shadowResponse =
                                    JSONObject.parseObject(dataStr, new TypeReference<ShadowResponse<String>>() {}.getType());
    ...
    private void shadowUpstream(String requestData) {
        ...
        LinkKit.getInstance().getDeviceShadow().shadowUpload(requestData, new IConnectSendListener() {
            ...
            public void onResponse(ARequest aRequest, AResponse aResponse) {
                ALog.d(TAG,
                    "onResponse() called with: aRequest = [" + aRequest + "], aResponse = [" + (aResponse == null ? null : aResponse.data) + "]");
                try {
                    if (aRequest instanceof MqttPublishRequest && aResponse != null) {
                        ...
                        ShadowResponse<String> response = JSONObject.parseObject(dataStr, new TypeReference<ShadowResponse<String>>() {}.getType());
