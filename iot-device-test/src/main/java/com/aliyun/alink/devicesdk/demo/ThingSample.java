...
public class ThingSample extends BaseSample {
    ...
    private ITResRequestHandler    mCommonHandler        = new ITResRequestHandler() {
                                                             public void onProcess(String identify, Object result,
                                                                 ...
                                                                 try {
                                                                     if (SERVICE_SET.equals(identify)) {
                                                                          ...
                                                                          * 若设置失败，需要将isSetPropertySuccess写为false,
                                                                          * demo将不更新云平台中的属性值
                                                                          *
                                                                         ...
                                                                         if (isSetPropertySuccess) {
                                                                             if (result instanceof InputParams) {
                                                                                 Map<String, ValueWrapper> data =
                                                                                     (Map<String, ValueWrapper>)((InputParams)result).getData();
                                                                                 // 如果控制台下发了属性OverTiltEnable，
                                                                                 // 可以通过data.get("OverTiltEnable")来获取相应的属性值
                                                             ...
                                                             public void onSuccess(Object o, OutputParams outputParams) {
                                                                 ALog.d(TAG, "onSuccess() called with: o = [" + o + "], outputParams = ["
                                                                     + outputParams + "]");
                                                                 ALog.d(TAG, "注册服务成功");
                                                             }
                                                             ...
                                                             public void onFail(Object o, ErrorInfo errorInfo) {
                                                                 ALog.d(TAG,
                                                                     "onFail() called with: o = [" + o + "], errorInfo = [" + errorInfo + "]");
                                                                 ALog.d(TAG, "注册服务失败");
                                                             }
                                                         };
    /**
    ...
    private IConnectNotifyListener connectNotifyListener = new IConnectNotifyListener() {
                                                             public void onNotify(String connectId, String topic, AMessage aMessage) {
                                                                 ALog.d(TAG, "onNotify() called with: connectId = [" + connectId + "], topic = ["
                                                                     + topic + "], aMessage = [" + printAMessage(aMessage) + "]");
                                                                 try {
                                                                     if (CONNECT_ID.equals(connectId) && !StringUtils.isEmptyString(topic) &&
                                                                         topic
                                                                             .startsWith("/sys/" + productKey + "/" + deviceName + "/rrpc/request")) {
                                                                         ALog.d(TAG, "收到云端系统RRPC下行" + printAMessage(aMessage));
                                                                         // ALog.d(TAG, "receice Message=" + new
                                                                         // String((byte[]) aMessage.data));
                                                                         // 服务端返回数据示例
                                                                             ...
                                                                             new IConnectSendListener() {
                                                                                                                                      public void
                                                                                                                                          onResponse(
                                                                                                                                              ...
                                                                                                                                              AResponse aResponse) {
                                                                                                                                          ALog.d(TAG,
                                                                                                                                              "onResponse() called with: aRequest = ["
                                                                                                                                                  + aRequest
                                                                                                                                                  + "], aResponse = ["
                                                                                                                                                  + aResponse
                                                                                                                                                  + "]");
                                                                                                                                      ...
                                                                                                                                      public void
                                                                                                                                          onFailure(
                                                                                                                                              ...
                                                                                                                                              AError aError) {
                                                                                                                                          ALog.d(TAG,
                                                                                                                                              "onFailure() called with: aRequest = ["
                                                                                                                                                  + aRequest
                                                                                                                                                  + "], aError = ["
                                                                                                                                                  + getError(
                                                                                                                                                      aError)
