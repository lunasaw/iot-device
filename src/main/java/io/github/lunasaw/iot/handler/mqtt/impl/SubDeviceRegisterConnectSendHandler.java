...
public class SubDeviceRegisterConnectSendHandler extends AbstractConnectSendHandler {
    ...
    private static @Nullable ResponseBO<List<IotSubDeviceBO>> getBoResponseBO(RequestSendDTO requestSendDTO) {
        ...
        return JSON.parseObject(data.toString(), new TypeReference<ResponseBO<List<IotSubDeviceBO>>>() {});
    }
    ...
    public void onResponse(RequestSendDTO requestSendDTO) {
        ...
        ResponseBO<List<IotSubDeviceBO>> boResponseBO = getBoResponseBO(requestSendDTO);
